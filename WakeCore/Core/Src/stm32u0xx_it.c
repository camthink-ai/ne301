...
/**
  * @brief This function handles Window watchdog interrupt + Independent watchdog interrupt.
  */
void WWDG_IWDG_IRQHandler(void)
{
  /* USER CODE BEGIN WWDG_IWDG_IRQn 0 */
  
  /* USER CODE END WWDG_IWDG_IRQn 0 */
  HAL_IWDG_IRQHandler(&hiwdg);
  /* USER CODE BEGIN WWDG_IWDG_IRQn 1 */

  /* USER CODE END WWDG_IWDG_IRQn 1 */
}
...
void EXTI0_1_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(CONFIG_KEY_Pin);
...
void EXTI2_3_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(PIR_TRIGGER_Pin);
...
void EXTI4_15_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(WIFI_SPI_IRQ_Pin);
